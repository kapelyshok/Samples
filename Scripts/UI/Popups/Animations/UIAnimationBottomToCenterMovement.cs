...
{
    [CreateAssetMenu(fileName = "BottomToCenterMovement", menuName = "UIAnimations/UIAnimationTopToCenterMovement")]
    public class UIAnimationBottomToCenterMovement : UIAnimation
    {
            ...
            Action onCompletedCallback = null)
        {
            ...
            var startPosition = new Vector3(0, Screen.height, 0);
