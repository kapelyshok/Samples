...
{
    [CreateAssetMenu(fileName = "TopToCenterMovement", menuName = "UIAnimations/UIAnimationBottomToCenterMovement")]
    public class UIAnimationTopToCenterMovement : UIAnimation
    {
