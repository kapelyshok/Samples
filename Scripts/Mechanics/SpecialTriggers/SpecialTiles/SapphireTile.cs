...
{
    public class SapphireTile : ABaseSpecialTile, ISecondWaveTriggerListener
    {
        ...
        [SerializeField]
        private int cellIndexToStartFrom = 5;
        ...
        public override async UniTask ProcessTile(ITriggerInitiator initiator)
        {
            ...
            bool isSuccess = selectedLetterCellView.CellPosition >= cellIndexToStartFrom;
